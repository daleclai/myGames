...
- Login over HTTPS
- Search engine that holds a gaming API (https://rawg.io/apidocs)
...
- **HTML5** - Four HTML pages. Use hyperlinks to move between them. One for the main page with search. Another the randomizer. Another to view other users. Lastly, one to create/login and see your account.
- **CSS3** - Style each page that can be used on different sceens. Uses good styling to look like a game app.
- **React/TypeScript** - Provides login, write reviews, and randomize API games. 
